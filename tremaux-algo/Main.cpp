    ...
    void tremaux(){
        ...
        while(!(curr_cell[0]==dest[0] && curr_cell[1]==dest[1])){
            ...
            //Intersection found
                ...
                if(!API::wallLeft() && cells[left_cell[0]][left_cell[1]].mark==1){
                    cells[left_cell[0]][left_cell[1]].mark=2;
                    turn_left();
                    move_forward();
                    continue;
                }
                if(!API::wallFront() && cells[front_cell[0]][front_cell[1]].mark==1){
                    cells[front_cell[0]][front_cell[1]].mark=2;
                    move_forward();
                    continue;
                }
                if(!API::wallRight() && cells[right_cell[0]][right_cell[1]].mark==1){
                    cells[right_cell[0]][right_cell[1]].mark=2;
                    turn_right();
                    move_forward();
                    continue;
                }
